...
model_hybrid = train_model(model_hybrid, criterion, optimizer_hybrid,exp_lr_scheduler, num_epochs=6)


score= model_hybrid[1]
...
print("Final Grade evaluated by 2-qubits gate and accuracy:",score*(0.999**gatecount))